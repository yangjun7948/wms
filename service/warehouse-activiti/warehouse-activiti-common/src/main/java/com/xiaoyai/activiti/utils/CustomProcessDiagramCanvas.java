...
public class CustomProcessDiagramCanvas {
    ...
    protected static final int FONT_SPACING = 0;
    protected static final int TEXT_PADDING = 0;
    ...
    public CustomProcessDiagramCanvas(int width, int height, int minX, int minY, String imageType, String activityFontName, String labelFontName, ClassLoader customClassLoader) {
        ...
        this.minX = minX;
        this.minY = minY;
        LOGGER.info("CustomProcessDiagramCanvas初始化参数为 activityFontName：{}，labelFontName：{}",activityFontName,labelFontName);
