...
import com.xiaoyai.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(com.xiaoyai.common.config.WareHouseConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
